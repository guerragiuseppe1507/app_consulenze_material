...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    public void showProgress(final boolean show, final boolean action) {
        // On Honeycomb MR2 we have the ViewPropertyAnimator APIs, which allow
        // for very easy animations. If available, use these APIs to fade-in
        // the progress spinner.
        if (action && VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
        ...
        } else if (!action && VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
            int shortAnimTime = getResources().getInteger(android.R.integer.config_shortAnimTime);
    ...
    public void toRegistraUtente(View view){
